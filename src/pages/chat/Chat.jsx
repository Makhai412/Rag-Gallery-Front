    ...
    return (
        <div className="flex flex-col h-screen p-4 mt-2 py-8 bg-blue-300">
                        ...
                        {message.sender === 'user' ? (
                            <div className="flex flex-col gap-1 w-full max-w-[320px]">
                                <div className="flex items-center space-x-2 rtl:space-x-reverse">
                                    <img className="w-8 h-8 rounded-full" src="https://i.ibb.co/1XrCBKP/usuario.png" alt="User Avatar"/>
                                ...
                                <div className="flex flex-col leading-1.5 p-4 border-blue-600 bg-blue-200 rounded-e-xl rounded-es-xl">
                            ...
                            <>
                                <img className="w-8 h-8 rounded-full" src="https://i.ibb.co/jRhMpP5/Avatar-Sistema.png" alt="System Avatar"/>
                                <div className="flex flex-col gap-1 w-full max-w-[320px]">
                                    <div className="flex items-center space-x-2 rtl:space-x-reverse">
                                        <span className="text-sm font-semibold text-gray-900">Sistema</span>
                                        <span className="text-sm font-normal text-gray-500">{message.time}</span>
                                    </div>
                                    <div className="flex flex-col leading-1.5 p-4 border-gray-600 bg-gray-200 rounded-e-xl rounded-es-xl">
                                        <p className="text-sm font-normal text-gray-900">{message.text}</p>
                                    </div>
                                    <span className="text-sm font-normal text-gray-500">Delivered</span>
                                </div>
            ...
            <form className="mt-4 w-3/4 mx-auto flex">
                <input type="file" ref={fileInputRef} onChange={handleFileChange} style={{ display: 'none' }}  disabled={!isLoggedIn} />
                ...
                />
                <button onClick={handleSendMessage} className="ml-2 p-2 bg-blue-500 text-white rounded-lg hover:bg-blue-700" disabled={isSending || !inputValue || !isLoggedIn}>
